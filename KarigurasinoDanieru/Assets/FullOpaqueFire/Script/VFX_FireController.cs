...
namespace YourNamespace
{
    ...
    public class VFX_FireController : MonoBehaviour
    {
        ...
        private float[] defaultFireRateValues;        // Valeurs par dÈfaut du spawn rate (Emission)
        private float[] defaultFireStartSizeValues;     // Valeurs par dÈfaut de la taille (Main > startSize)
        ...
        {
            // En mode Èditeur, il se peut qu'Awake() ne soit pas appelÅE
            // donc on s'assure que les tableaux sont initialisÈs.
        ...
        /// <summary>
        /// Recherche tous les ParticleSystem enfants et sauvegarde leurs valeurs par dÈfaut.
        ...
        /// <summary>
        /// Applique les rÈglages sur chaque ParticleSystem enfant.
        /// Les valeurs par dÈfaut sont multipliÈes par fireIntensity, exactement comme pour le spawn rate.
        /// </summary>
        private void ApplyFireSettings()
        {
            // S'assurer que tous les tableaux sont initialisÈs correctement.
            if (fireParticleSystems == null || fireParticleSystems.Length == 0 ||
                defaultFireRateValues == null || defaultFireStartSizeValues == null ||
                defaultFireRateValues.Length != fireParticleSystems.Length ||
                defaultFireStartSizeValues.Length != fireParticleSystems.Length)
            ...
            for (int i = 0; i < fireParticleSystems.Length; i++)
            {
                ...
                // Modifier le spawn rate en multipliant la valeur par dÈfaut par fireIntensity
                ...
                // Modifier la taille des particules de la mÍme maniËre
